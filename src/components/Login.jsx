const Login = () => {
    return (
        ...
        <h2 className="font-bold md:text-xl lg:text-2xl text-neutral-800">INGRESO CLIENTES</h2>
      <form action="#" className="my-4">
        <label htmlFor="username" className="block font-bold">Username</label>
        <input type="text" name="username" required placeholder="Ej: ejemplo@intercarchile.cl" className="bg-neutral-200 rounded-md placeholder:text-neutral-400 placeholder:text-sm text-neutral-800 border-2 border-transparent focus:border-orange-500 focus:outline-none w-10/12"/>
        <label htmlFor="pswd" className="block font-bold">Contraseña</label>
