    ...
    return (
        <div className="flex justify-center py-2 border-b-2">
            <div className="bsq duration-500 focus-within:w-3/4 w-2/4 text-center">
                    <input className="h-6 bg-transparent border-2 shadow-sm text-sm focus:outline-none  focus:border-orange-200 rounded-sm w-2/3" type="text" name="" placeholder="¡Busca acá!" id="" />
            </div>
