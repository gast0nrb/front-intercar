...
const Vacio = ({msjPequeño, msjGrande}) => {
    return (
        ...
        <div className="w-10/12 shadow-md text-center mx-auto my-20 rounded-md border-2 p-2">
            <h2 className="text-neutral-800 font-extrabold">{msjGrande.toUpperCase()} :(</h2>
