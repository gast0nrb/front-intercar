...
const CardListado = ({
  ...
  function acceptChange() {
    //Confirmar cambios y los setea al objeto pasado por context
    let arr = [...Productos];
  ...
  function cancelarCange() {
    //Cancelar los cambios y vuelve al valor del objeto pasado por context
    ...
    <>
      <div className="flex md:flex-wrap lg:flex-nowrap h-auto rounded-t-md border-t-2">
        ...
        <div className="w-full">
          <h3 className="text-2xl w-full font-bold text-neutral-300 bg-neutral-800">
            {title.toUpperCase()}
          </h3>
          <p className="lg:text-xl md:text-sm font-bold text-neutral-800">
      ...
      {checkProp ? ( //Si el chequeo es true, desplegara el div con la info de agotado o no
        <div className="w-full border-b-2">
          ...
          >
            PRODUCTO {state ? "AGOTADO" : "DISPONIBLE"}
          </h3>
        </div>
      ) : (
        <></>
      ...
      <div className="w-full border-b-2">
        <h3 className="text-orange-500 font-bold bg-neutral-800">
          SKU:{codigo}
        </h3>
      </div>
          ...
          checkProp ? (
            ...
            <div className="grow justify-center basis-3/12 bg-neutral-800 border-b-2">
              ...
              <div className="flex justify-center">
                ...
                {
                  //Arreglar para cambiar el valor escribiendo números
                  <input
                    className="w-10 mx-5 bg-neutral-800 text-neutral-300 outline-none text-center"
                    placeholder=""
                    type="text"
                    value={change ? acumulador : Productos[index].cantidad}
                  />
                }
                <button
                  onClick={() => changeCantidad(1)}
      ...
      {!checkProp ? ( //Si no se ha revisado la cotización se despliegan los botones de manipulación
        <div className="flex grow bg-neutral-800">
          <div className="basis-1/3 grow border-b-2">
            <button
              className="text-neutral-300 enabled:text-red-500 enabled:font-bold md:text-xs lg:text-sm"
          ...
          <div className="basis-1/3 grow border-b-2">
            <button
              className="text-neutral-300 enabled:text-orange-500 enabled:font-bold md:text-xs lg:text-sm"
